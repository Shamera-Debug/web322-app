...
* 
*  Name: Hyunjun Kim Student ID: 129550182 Date: 07/21/2022
*
*  Online (Heroku) URL: https://whispering-reaches-12203.herokuapp.com/
*
*  GitHub Repository URL: https://github.com/Shamera-Debug/web322-app.git
*
********************************************************************************/
...
app.get('/posts/delete/:id', (req,res)=>{
    blogData.deletePostById(req.params.id).then(data=>{
        ...
        res.status(500).send("Unable to Remove Posts / Posts not found)");
    });
});
